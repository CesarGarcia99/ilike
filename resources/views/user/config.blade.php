...
<div class="container container-principal">
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="card">
                <div class="card-header card-content">{{ __('Configura tu cuenta') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ Route('user.update') }} "enctype='multipart/form-data'>
                        ...
                        <div class="row mb-3">
                            <label for="nick" class="col-md-4 col-form-label text-md-end">{{ __('Usuario') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="image_path" class="col-md-4 col-form-label text-md-end">{{ __('Imagen de perfil') }}</label>
